...
SEASON_DEFAULT = data.SEASON_DEFAULT
...
to_pandas = data.to_pandas
first_col = data.first_col
num = data.num
numc = data.numc
score_actual = data.score_actual
score_expected = data.score_expected
...
def load_player_stats(season: int) -> pd.DataFrame:
    return data.load_player_stats(season)
...
def load_ff_opportunity(season: int) -> pd.DataFrame:
    return data.load_ff_opportunity(season)
...
def load_routes(season: int) -> pd.DataFrame:
    return data.load_routes(season)


@st.cache_data(ttl=CACHE_TTL, show_spinner=False)
def load_injuries(season: int) -> pd.DataFrame:
    return data.load_injuries(season)
...
def load_rosters(season: int) -> pd.DataFrame:
    return data.load_rosters(season)
