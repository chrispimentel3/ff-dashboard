...
TOPICS = [
    ...
    },
    {
        ...
        "detail": (
            ...
            "- **Draft value / value_delta (Draft value page)** asks *did this pick age "
            "well?* The league's actual draft slots are lined up against today's "
            "FantasyCalc rank in that same order — the 24th pick \"should\" hold roughly "
            "the 24th-highest value today. `value_delta` is the gap between where a player "
            "actually sits and where his draft slot predicted: a big positive number is a "
            "riser, a big negative one is a faller. It says nothing about your specific "
            "roster — it's a league-wide draft-grade, not a trade recommendation by itself.\n"
